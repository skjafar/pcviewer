...
QT_MOC_LITERAL(8, 116, 18)
    ...
    "RegisterWidget\0focusRegisterChoice\0\0"
    "onAddressChange\0onValueChange\0onError\0"
    "request_error_t\0on_txtValue_returnPressed\0"
    "on_btnPlot_clicked\0"
};
...
void RegisterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->focusRegisterChoice(); break;
        case 1: _t->onAddressChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->onValueChange(); break;
        case 3: _t->onError((*reinterpret_cast< request_error_t(*)>(_a[1]))); break;
        case 4: _t->on_txtValue_returnPressed(); break;
        case 5: _t->on_btnPlot_clicked(); break;
        default: ;
        }
    }
}
